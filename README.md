...
| [`docs/qualitaetsleitplanken-produktreife.md`](docs/qualitaetsleitplanken-produktreife.md) | Ergänzender Reviewkatalog für den Weg von der Demo zum Produkt: Reifestufen, Risikoklassen, Qualitätschecks, Nachweise, Gegenlesen und offene Entscheidungen — ohne Vertrag, Fachregeln oder Arbeitsordnung zu duplizieren. |
