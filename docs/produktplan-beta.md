...
| Dokumente, ADRs, Runbook, Drehbuch, Datenschutz-Paket | Architekt | Architekt (Text) + Implementierer-Backend (Generatoren) | Reviewer (Lesebefund) | Jede Anleitung wird einmal von einem fremden Modell befolgt |
