...
**Zielgruppe.** Die KI-Agenten, die bauen, prüfen und dokumentieren (Architekt, Planer, Implementierer-Backend, Implementierer-Oberfläche, Reviewer und Design-Kritik; Mechaniker für reine Mechanik; das Modell je Rolle steht nur in `.claude/agents/`, Besetzung nach takt-012), und der Umsetzer, der Bautage startet, den Tagesbericht liest, an den Prüfpunkten entscheidet, Deployments freigibt (Regel 11) und die wenigen privilegierten Schritte nach Checkliste ausführt. Die Projektleitung liest die Abschnitte 1, 8, 10 und 11.
...
- **012 · Architektur- und Sicherheitstore, Tor-Inventar ehrlich** — mittel · 2 AStd · Kalender 29.09.2026 (W1) · Lanes: infra
  ...
  - *Abhängigkeiten:* 009
  - *Rolle:* Implementierer-Backend; Mechaniker (Konfigdateien); Review
...
- **014 · Entscheidungsregister, Abdeckungsmatrix, Fragenpaket, DSFA-Vorentwurf, Takt-Skript** — niedrig · 2,5 AStd · Kalender 29.09.2026 (W1) · Lanes: docs-register
  ...
  - *Abhängigkeiten:* 009
  - *Rolle:* Architekt; Mechaniker (Skript, Screenshot); Review
...
- **015 · ADR-Paket 0003–0016 als vorgeschlagen** — niedrig · 2,5 AStd · Kalender 30.09.2026 (W1) · Lanes: docs-adr
  ...
  - *Abhängigkeiten:* 009
  - *Rolle:* Architekt; Review (Konsistenz mit Recherche, Rechtekonzept, ADR 0001)
  - *Nachweise:* 14 Dateien plus Ergänzung 0002, Register verweist auf jede ADR, Lesebefund des Reviewers ohne Blocker
  - *Offene Entscheidung:* —
...
- **010 · Lesepfade unter can() mit Leserechten** — hoch · 2 AStd · Kalender 06.10.2026 (W2) · Lanes: core, contract, service, web-speakers, web-capture, web-answers, web-stage, web-history, e2e
  ...
  - *Abhängigkeiten:* 019
  - *Rolle:* Implementierer-Backend; Review mit Perspektive Security
...
- **082 · Feature-Register für Routen, Navigation, Kürzel und Hilfe** — niedrig · 1 AStd · Kalender 05.10.2026 (W2) · Lanes: web-shell
  ...
  - *Offene Entscheidung:* —
- **080 · Redezeit und Art zurückbauen, Sprecher-Zustandstabelle R-SPK** — hoch · 1,5 AStd · Kalender 08.10.2026 (W2) · Lanes: core, web-speakers
  - *Ziel:* Kern, Seed, Projektion und Web ohne kind/requestedMinutes (Spalten und Dialogfelder in apps/web/src/features/speakers, SpeakingTimer entfernt; Seed zieht die Zufallszahlen weiter); SPEAKER_TRANSITIONS als Daten (waiting→speaking, speaking→finished, waiting→withdrawn, speaking→withdrawn, finished→waiting nur mit Grund „Nachfrage") mit R-SPK-01..05, legalRef, generiertem Test je Zeile; updateSpeaker prüft gegen die Tabelle. Geteilt am 25.09. (Spec docs/slices/080-sprecher-zustand-rueckbau.md): Korpus und Umsortierung → 080b; das Löschen der veralteten Vertragsfelder → 0.4.0 (043, ADR 0015: nicht additiv, 0.3.1 gehört 028). Quellen: Feedback #15; Ist-Analyse Sprecherstatus.
...
- **084 · CI-Job-Matrix und Zeitbudget nach Korpuswechsel** — niedrig · 1 AStd · Kalender 12.10.2026 (W3) · Lanes: infra, e2e
  ...
  - *Rolle:* Mechaniker + Implementierer-Oberfläche (Zeitbudget-Spec); Review
...
- **039 · Bedrohungsmodell v1 und Pentest-Scope** — mittel · 1 AStd · Kalender 05.10.2026 (W2) · Lanes: docs-sicherheit
  ...
  - *Abhängigkeiten:* 015
  - *Rolle:* Reviewer (Perspektive Security, nur Read); Review in frischem Kontext mit Perspektive Security
...
- **028 · Idempotenz persistiert, If-Match Pflicht mit Vertrag 0.3.2, Contribution-Version, Claim/Lease, Zwei-Schreiber-Test** — hoch · 2 AStd · Kalender 20.10.2026 (W4) · Lanes: core, contract, web-capture, service
  - *Ziel:* Idempotenzschlüssel werden aus dem Ereignislog rekonstruiert (idempotencyKey im Umschlag); If-Match Pflicht (428 ohne Header) auf allen mutierenden Vorgangs-, Redebeitrags- und Wortmeldungsoperationen außer „Vorgelesen", das den Versions-Hash prüft (049); Vertrag 0.3.2 macht If-Match und die in 0.3.0 optional eingeführten Felder zur Pflicht, der Allowlist-Eintrag entfällt; Contribution und Wortmeldeliste tragen version; Übernahme-Sperre: ContributionClaimed/QuestionClaimed mit TTL 10 min (Daten, keine harte Sperre, Ablauf gibt frei); Tests „zwei Schreiber, eine Version" für captureQuestions und reorderSpeakers; Neustart-Idempotenz-Test. Die Scheibe montiert die Routen ihrer Operationen aus Vertrag 0.3.0 im Dienst (`apps/api/src`) und entfernt deren Einträge aus `packages/contract/allowlist.json` (die Operationen stehen dort mit Feld `slice` = 028).
...
- **038 · Backup, Restore, Rebuild-Drill, Jahrgangs-Export, RPO/RTO/SLO** — hoch · 2 AStd · Kalender 02.11.2026 (W6) · Lanes: persist, docs-betrieb
  ...
  - *Rolle:* Implementierer-Backend; Review mit Perspektive Betrieb; Umsetzer führt den Drill einmal selbst aus
...
- **040 · Administration im Kern: Jahrgang, Stammdaten, Bühnenplätze, Einheiten, Rollen, Konfigurationsfreeze** — hoch · 2,5 AStd · Kalender 03.11.2026 (W6) · Lanes: core, service
  - *Ziel:* Jahrgang anlegen/klonen, Fachbereiche, TOPs, Bühnenplätze (Liste je Jahrgang, Person und Gerätekennung je Platz), Personen einer Einheit zuordnen, Einheit „AR-Büro" im Seed, counts.byUnit und counts.bySeat in der Projektion, Rollenzuordnung mit Ablauf und zwei Vertretungen, Meeting-Lebenszyklus-Aktionen, Nummernkreise je Erfassungsplatz als Meeting-Daten (für den Papierpfad), Konfigurationsfreeze (Ereignis ConfigFrozen mit Hash über Rechtetabelle, Übergangstabelle, Stammdaten; Änderung danach nur mit admin.override und Grund); alles Ereignisse, deny by default, R-ADM-01..04. Die Scheibe montiert die Routen ihrer Operationen aus Vertrag 0.3.0 im Dienst (`apps/api/src`) und entfernt deren Einträge aus `packages/contract/allowlist.json` (die Operationen stehen dort mit Feld `slice` = 040).
...
- **047 · Vertraulichkeitsstufe, attributbasierte Rechte, Podium-Sichtbarkeit, Insider-Kennzeichen** — hoch · 3 AStd · Kalender 10.11.2026 (W7) · Lanes: core
  ...
  - *Rolle:* Implementierer-Backend + Mechaniker (Badge); Review mit Perspektive Security/Datenschutz
...
- **058 · Podium offline: Lesepuffer, Absichtswarteschlange, Wiederaufnahme, Test auf realer Geräteklasse** — hoch · 2,5 AStd · Kalender 23.11.2026 (W9) · Lanes: web-stage
  ...
  - *Zielbild (089):* Z18, Teil Rückgängig-Fenster: „vorgelesen" wird 5 s lokal als Absicht gehalten und erst danach gesendet, Rückgängig als Schaltfläche ohne eigene Taste (im Standard von E52, rund 0,5 AStd zusätzlich). Quelle `docs/feedback/2026-09-zielbild-oberflaeche.md`, Bild `docs/zielbild/` und `docs/evidence/089-*.png`; Gestaltungsreferenz, nicht Spec: die Spec übernimmt die Punkte als Text, Maßstab bleibt D1–D10; Namen und neue Begriffe nach der README dort.
...
- **066 · KI-Port ohne Anbieter** — mittel · 1,5 AStd · Kalender 20.11.2026 (W8) · Lanes: service, web-answers
  ...
  - *Rolle:* Implementierer-Backend + Mechaniker (Anzeige); Review
...
- **064 · Transkript-Ingest: Endpunkt, unveränderliche Segmente, Datei-Adapter, Partnerleitfaden** — hoch · 2,5 AStd · Kalender 26.11.2026 (W9) · Lanes: service, web-capture
  ...
  - *Rolle:* Implementierer-Backend + Implementierer-Oberfläche; Review mit Perspektive Security
...
- **067 · Aktienregister-JIT-Lookup-Port und Aufdecken als Ereignis** — hoch · 2 AStd · Kalender 30.11.2026 (W10) · Lanes: core, service, web-speakers
  ...
  - *Rolle:* Implementierer-Backend + Implementierer-Oberfläche; Review mit Perspektive Datenschutz
...
- **086 · Kanarienfrage** — mittel · 2 AStd · Kalender 02.12.2026 (W10) · Lanes: service, core
  ...
  - *Rolle:* Implementierer-Backend; Review mit Perspektive Betrieb
...
- Lastbericht mit p90-Werten; Chaos-Protokoll; Runbook, Admin-, Integrations-, Entwickler-Anleitung von einem Agenten in frischem Kontext ohne Vorwissen befolgt.
...
- **070 · Runbook v1, Datenpanne, Freeze-Kalender** — mittel · 2 AStd · Kalender 24.11.2026 (W9) · Lanes: docs-betrieb
  ...
  - *Rolle:* Architekt; Review mit Perspektive Betrieb
...
- **072 · Chaos- und Failover-Katalog auf Staging** — hoch · 2 AStd · Kalender 03.12.2026 (W10) · Lanes: infra, docs-betrieb
  ...
  - *Rolle:* Implementierer-Backend; Review mit Perspektive Betrieb; Umsetzer führt zwei Szenarien selbst aus
...
- **076 · Rechtsprüfungs-Nachtrag: legalRef und Verweigerungskatalog auf verified** — hoch · 1,5 AStd · Kalender 01.02.2027 (W19) · Lanes: core, docs-legal
  ...
  - *Rolle:* Mechaniker (Datenpflege); Review mit Perspektive Legal; Freigabe durch Eigentümer
...
- **078 · Generalprobe-Drehbuch, Login-Check, Support-Rota, Drill und Generalprobe** — hoch · 2,5 AStd · Kalender 15.02.–05.03.2027 (W21–W23) · Lanes: docs-betrieb
  ...
  - *Rolle:* Architekt (Drehbuch) + Eigentümer (Durchführung); Review
...
- **079 · Beta-Abnahme B1–B18, Restliste, Nach-Beta-Backlog** — hoch · 2,5 AStd · Kalender 08.03.–11.03.2027 (W24) · Lanes: docs-plan
  ...
  - *Rolle:* Reviewer (frischer Kontext, sieht nur Kriterien und Repositorium); Architekt (Restliste); Eigentümer unterschreibt
...
| Scheibentyp | Spec | Bau | Review (frischer Kontext, nur Spec und Diff) | Zusätzlich |
|---|---|---|---|---|
| Kern und Rechte (core, Risikoklasse hoch) | Architekt, Planer | Implementierer-Backend | Reviewer mit benannter Perspektive (Security, Datenschutz, Legal); bei 044 Verweigerung zusätzlich Stichprobe des Architekten mit Perspektive Legal | Wahrheitstabellen-Diff steht vor dem Bau in der Spec |
| Vertragspakete (contract) | Architekt | Architekt (019, 023, 043) oder Mechaniker (077) | Reviewer gegen Recherche und Rechtekonzept | Changelog-Tor, Allowlist mit Ablauf |
| Persistenz, Dienst, Infrastruktur | Planer | Implementierer-Backend | Reviewer mit Perspektive Betrieb/Security | Eigentümer führt privilegierte Checklisten aus |
| Oberfläche | Planer | Implementierer-Oberfläche | Reviewer | Design-Kritik vor dem Review (Checkliste D1–D10, Screenshots DE/EN, Kontrastprobe); bei 056 in frischem Kontext, nicht die Sitzung, die die Spec schrieb |
| Mechanik (i18n, Konstanten, Datenpflege, Screenshots, Protokolle, Skripte) | Planer oder Architekt | Mechaniker | Reviewer | Positivliste der Verzeichnisse |
| Dokumente, ADRs, Runbook, Drehbuch, Datenschutz-Paket | Architekt | Architekt (Text) + Implementierer-Backend (Generatoren) | Reviewer (Lesebefund) | Jede Anleitung wird einmal von einem Agenten in frischem Kontext ohne Vorwissen befolgt |
| Bedrohungsmodell, Sicherheitsprüfung, Beta-Abnahme | — | Reviewer (Perspektive Security, nur Read) | Review in frischem Kontext mit Perspektive Security | Abnahme 079 sieht nur Kriterien und Repositorium |
...
- **Design-Kritik.** Die Design-Kritik prüft vor jedem Review einer Oberflächenscheibe Screenshots DE/EN, Kontrast und D1–D10; Blocker gehen zurück an den Implementierer, nicht an den Reviewer.
- **Sicherheitsreview des Architekten.** An den Prüfpunkten 3, 4 und 7 liest der Architekt den Gesamtstand mit der Perspektive Security (Modus des Architekten nach docs/agentische-entwicklung-plan.md Abschnitt 3).
...
| Abnahme | 12.03.2027 | 079 | Beta-Abnahmebericht mit 18 Zeilen; Abnahme durch den Reviewer in frischem Kontext; Tag beta-1 | Eigentümer unterschreibt die Abnahme |
...
| Vertragsbrüche brechen e2e, Seed und Demo mehrfach | Drei gebündelte Vertragspakete vom Architekten (019, 023, 043) plus 0.3.2 in 028; neue Pflichtfelder erst optional mit Ablauf; eine Korpusquelle; Alias /v1/meeting; Changelog-Tor; generierter Client; Allowlist mit Ablauf; Freeze in 077 |
