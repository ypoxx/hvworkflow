...
| Historie | Alle Ereignisse, nur anhängend, mit `personId` statt Klarname | Recht, Freigabe, Beobachter (lesend); Revision hat in der Beta kein Konto (E24); personenbezogene Auswertung nur mit zweiter Freigabe | Aktionär und Beschäftigte |
...
| V12 | Rollenzuordnung je Jahrgang | subject → Rollen, optional Einheit, Ablaufdatum; Ereignisse RoleAssigned/RoleRevoked | Beschäftigte | Berechtigungsverwaltung, Nachweis „wer durfte was am HV-Tag" | wie V11 — **zu prüfen** | Administration; Beobachter (lesend); Revision ohne Konto in der Beta (E24) | record | Ablauf am Jahrgangsende; eingefrorener Rechte-Snapshot je Jahrgang (026, 077) |
