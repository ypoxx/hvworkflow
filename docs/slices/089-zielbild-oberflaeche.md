...
5. **Register** `docs/entscheidungsregister.md`: E50 (Erwartungskarte), E51 (Zahlenprüfung), E52 (Halten statt
   Leertaste, Rückgängig), E53 (dunkler Bühnenmodus), E54 (Rückkanal zur Bühne), je mit allen neun Spalten und
   Status `offen`.
...
3. E50–E54 im Register mit neun Spalten, Status `offen`; die Matrix-, Register- und Planzeilen verweisen
   aufeinander.
