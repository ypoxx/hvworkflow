...
const TOUR = [
  ...
  { v: 'schreibraum', s: '#editor .num.conflict', f: '#editor', pos: 'l', t: 'Jede Zahl wird geprüft',
    d: 'Der Entwurf nennt 45 Prozent. Vorgelesen wurden an anderer Stelle 47 Prozent, und die Einladung schlägt 1,85 Euro vor. Rot markiert, bevor Legal danach suchen muss. Rechts steht die Korrektur per Klick.' },
  ...
  { v: 'schreibraum', s: '.checks', f: '#editor', pos: 'l', t: 'Alle Zahlen belegt',
    d: 'Jetzt sind alle Zahlen grün, die Belege gehen mit. Die Vorlesezeit liegt im Rahmen. Die Antwort kann zu Legal.',
